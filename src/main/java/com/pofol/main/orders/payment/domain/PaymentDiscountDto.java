...
public class PaymentDiscountDto {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(ord_id, that.ord_id) && Objects.equals(coupon_disc, that.coupon_disc) && Objects.equals(point_used, that.point_used) && Objects.equals(tot_prod_price, that.tot_prod_price) && Objects.equals(tot_pay_price, that.tot_pay_price) && Objects.equals(dlvy_fee, that.dlvy_fee);
    }

    @Override
    public int hashCode() {
        return Objects.hash(ord_id, coupon_disc, point_used, tot_prod_price, tot_pay_price, dlvy_fee);
    }
