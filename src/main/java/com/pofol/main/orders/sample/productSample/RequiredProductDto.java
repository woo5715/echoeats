...
public class RequiredProductDto {
    ...
    public RequiredProductDto(Long prod_id, String is_opt) {
        this.prod_id = prod_id;
        this.is_opt = is_opt;
    }

    public RequiredProductDto(Long prod_id, String is_opt, String opt_prod_id) {
        this.prod_id = prod_id;
        this.is_opt = is_opt;
        this.opt_prod_id = opt_prod_id;
    }

    public RequiredProductDto(Long prod_id, String prod_name, Integer prod_price, Integer disc_price, String is_opt, String opt_prod_id, String opt_prod_name, Integer opt_price, Integer opt_disc_price, String pack_type, String dlvy_type) {
        this.prod_id = prod_id;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(prod_id, that.prod_id) && Objects.equals(prod_name, that.prod_name) && Objects.equals(prod_price, that.prod_price) && Objects.equals(disc_price, that.disc_price) && Objects.equals(is_opt, that.is_opt) && Objects.equals(opt_prod_id, that.opt_prod_id) && Objects.equals(opt_prod_name, that.opt_prod_name) && Objects.equals(opt_price, that.opt_price) && Objects.equals(opt_disc_price, that.opt_disc_price) && Objects.equals(pack_type, that.pack_type) && Objects.equals(dlvy_type, that.dlvy_type);
    }

    @Override
    public int hashCode() {
        return Objects.hash(prod_id, prod_name, prod_price, disc_price, is_opt, opt_prod_id, opt_prod_name, opt_price, opt_disc_price, pack_type, dlvy_type);
    }
