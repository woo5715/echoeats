...
public class OptionProductDto {
  ...
  public OptionProductDto(String opt_prod_id, Long prod_id, String opt_prod_name, Integer opt_price, Integer opt_disc_price, Integer opt_prod_qty, String rg_num) {
