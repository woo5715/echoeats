    ...
    <div class="css-4c6dm7 epvroj93">
        ...
        <div class="css-134fy6p epvroj92">
            ...
            <div class="css-17t7y0p edbbr7c2"><h3 class="css-1ddzp0m edbbr7c1">적립금</h3></div>
                ...
                <%-- 결제하기 버튼 --%>
                <div class="css-1azakc el0c5j40"><button class="css-1lha8en e4nu7ef3" type="button" width="240" height="56" radius="3"><span class="css-nytqmg e4nu7ef1">28,025원 결제하기</span></button></div></div>
        ...
        <div class="css-1rz7w0y epvroj91"><div class="css-9i9om4 epvroj90"><div class="css-6hge48 edbbr7c2"><h3 class="css-1ddzp0m edbbr7c1">결제 금액</h3></div>
            <div class="css-hdnk73 e12lli9y0"><div class="css-1hvttuk eahaaoi12"><div class="css-1rmc3ba eahaaoi11">주문금액</div><div><span class="css-2pg1ps eahaaoi10" id="tot_prod_price">${checkout.tot_prod_price}</span><span class="css-158icaa eahaaoi8">원</span></div></div>
                ...
                <div class="css-sk644d eahaaoi9"><div class="css-zjik7 eahaaoi0"><svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M1 5H0V10V11H1H6V10H1V5Z" fill="#ddd"></path></svg><div class="css-1rmc3ba eahaaoi11">상품할인금액</div></div><div><span class="css-2pg1ps eahaaoi10"><span class="css-rfpchb eahaaoi3"><c:if test="${checkout.tot_prod_price != checkout.origin_prod_price}">-</c:if></span>${checkout.origin_prod_price - checkout.tot_prod_price}</span><span class="css-158icaa eahaaoi8">원</span></div></div>
                <div class="css-1bj5qaf eahaaoi12"><div class="css-1rmc3ba eahaaoi11">배송비</div><div><span class="css-2pg1ps eahaaoi10"><span class="css-rfpchb eahaaoi3"><c:if test="${checkout.dlvy_fee == 3000}">+</c:if></span><span id = "dlvy_fee">${checkout.dlvy_fee}</span></span><span class="css-158icaa eahaaoi8">원</span></div></div>
            <div class="css-1bj5qaf eahaaoi12"><div class="css-1rmc3ba eahaaoi11">쿠폰할인</div><div class="css-0"><span class="css-2pg1ps eahaaoi10"><span class="css-rfpchb eahaaoi3"></span>0</span><span class="css-158icaa eahaaoi8">원</span></div></div>
            <div class="css-1hvttuk eahaaoi12"><div class="css-1rmc3ba eahaaoi11">적립금</div><div><span class="css-2pg1ps eahaaoi10" id="outputReservesUsed"><span class="css-rfpchb eahaaoi3" ></span>0</span><span class="css-158icaa eahaaoi8">원</span></div></div>
                <div class="css-1hgn7mh eahaaoi7"><div class="css-1rmc3ba eahaaoi11">최종결제금액</div><div><span class="css-2pg1ps eahaaoi10"><span class="css-rfpchb eahaaoi3"></span><span id = "tot_pay_price">${checkout.tot_prod_price + checkout.dlvy_fee}</span></span><span class="css-158icaa eahaaoi8">원</span></div></div>
