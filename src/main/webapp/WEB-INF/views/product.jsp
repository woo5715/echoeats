...
<head>
    ...
    <link rel="stylesheet" href="resources/css/product-css.css"/>
    <title></title>
                ...
                <main id="product-atf" class="css-1eoy87d e17iylht5">
                    ...
                    <section class="css-1ua1wyk e17iylht3">
                        ...
                        <div class="css-1qy9c46 ezpe9l12">
                            <h1 class="css-79gmk3 ezpe9l11">[압구정주꾸미] 주꾸미 볶음 300g</h1>
                            <h2 class="css-ki8mlo ezpe9l10">마늘의 감칠맛이 듬뿍</h2>
                        ...
                        <h2 class="css-abwjr2 e1q8tigr4">
                            ...
                            <span class="css-9pf1ze e1q8tigr2">6,675</span>
                                        ...
                                        <g>
                                            <g>
                                                <g transform="translate(-339 -398) translate(0 386) translate(339 12) translate(4.69 6.343)">
                                                    <use stroke="#5f0080" stroke-linecap="round" stroke-width="1.2" stroke-linejoin="round" transform="rotate(45 5.657 5.657)" xlink:href="#gfk9q0rhta"></use>
                                                </g>
                                            </g>
                                        </g>
                                    </g>
                        ...
                        <ul class="css-iqoq9n e6qx2kx2">
                            ...
                            <li class="css-e6zlnr epzddad2">
                                ...
                                <dd class="css-1k8t52o epzddad0">
                                    <p class="css-c02hqi e6qx2kx1">냉동 (종이포장)</p>
                            ...
                            <li class="css-e6zlnr epzddad2">
                                ...
                                <dd class="css-1k8t52o epzddad0">
                                    <p class="css-c02hqi e6qx2kx1">
                                        - 대두, 밀 함유
                                        - 이 제품은 알레르기 발생 가능성이 있는 고등어 ,게 , 새우, 오징어 ,조개류(굴, 전복, 홍합을 포함)을 사용한 제품과 같은 제조시설에서 제조
                                    </p>
                                </dd>
                            </li>
                            <li class="css-e6zlnr epzddad2">
                                ...
                                <dd class="css-1k8t52o epzddad0">
                                    <p class="css-c02hqi e6qx2kx1">수령일 포함 180일 이상 남은 제품을 보내드립니다.(총 유통기한 365일)</p>
                                </dd>
                            </li>
                        </ul>
