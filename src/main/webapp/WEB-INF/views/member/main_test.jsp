    ...
    <div id="wrap-center">
        <div id="top">
            <div id="header">
                <div id="homeInfo">
                    ...
                    <div>
                        <a href="/member/board">고객센터<span></span></a>
                    </div>
                    <div class="menu">
                        <div>공지사항</div>
                        <div>자주하는 질문</div>
                ...
                <div id="search">
                    <div id="search-bar">
                        <img src="/resources/icons/kurly_logo.svg" alt="에코잇츠 로고">
                        <a>에코잇츠</a>
                        <div class="stick"></div>
                        <a>뷰티에코</a>
                ...
                <div id="main-02-left">
                    <div>
                        ...
                        <div>
                            ...
                            <div class="time-units"><span id="hours"></span><span id="minutes"></span><span id="seconds"></span></div>
                        </div>
                        <p>망설이면 늦어요!</p>
                    </div>
                </div>
                                    ...
                                    <div class="content-row">
                                        <div class="product-price">
                                            ...
                                            <div class="discount">
                                                ...
                                                <span class="sales-price">${eventOneList.prod_price}<span
                                                        class="won">원</span></span>
                                            </div>
                                        </div>
                                    </div>
        ...
        <footer>
            <div class="css-17cdx60 ebj6vxr6">
                <div id="footer" class="css-1i60c0e ebj6vxr5">
                    <div class="css-j6zuv6 ebj6vxr4">
                        ...
                        <div class="css-1fttcpj ebj6vxr3">
                            ...
                            <div class="css-bz7mfs ebj6vxr2">법인명 (상호) : 주식회사 에코 <span
                            ...
                            <ul class="css-zjik7 ek68y4g1"><a href="https://instagram.com/marketkurly" target="_blank"
                                    ...
                                    src="https://res.kurly.com/pc/ico/1810/ico_instagram.png" alt="에코 인스타그램 바로가기"></a><a
                                    ...
                                    alt="에코 네이버포스트 바로가기"></a><a
                                    href="https://www.youtube.com/channel/UCfpdjL5pl-1qKT7Xp4UQzQg" target="_blank"
                                    rel="noreferrer" class="css-9ipg3 ek68y4g0"><img
                                    src="https://res.kurly.com/pc/ico/1810/ico_youtube.png" alt="에코 유튜브 바로가기"></a></ul>
                        </div>
                    </div>
                    <div class="css-81eeg3 e1t23cq0">
                        <button class="css-12t5wjq e57xuci2"><img src="https://res.kurly.com/pc/ico/2208/logo_isms.svg"
                            ...
                            <p class="css-bft4sh e57xuci0">[인증범위] 에코 쇼핑몰 서비스 개발·운영<br>(심사받지 않은 물리적 인프라 제외)<br>[유효기간]
                ...
                <div class="css-175n8cp etk3uz81">에코에서 판매되는 상품 중에는 에코에 입점한 개별 판매자가 판매하는 마켓플레이스(오픈마켓) 상품이 포함되어 있습니다.<br>마켓플레이스(오픈마켓)
                    상품의 경우 에코는 통신판매중개자로서 통신판매의 당사자가 아닙니다. 에코는 해당 상품의 주문, 품질, 교환/환불 등 의무와 책임을 부담하지 않습니다.<em
