...
<head>
  <title>Title</title>
  <%@ include file="/WEB-INF/views/include/bootstrap.jspf" %>
...
<div class="container-fluid">
  <div class="row" style="padding-top:50px; padding-bottom: 50px">
    ...
    <div class="col-sm-6">
      ...
      <div>
        <form name="frm" method="post" action="${pageContext.request.contextPath}/admin1/faq/insert">
          <table class="table">
            <thead>
          ...
          <div style="text-align: right;">
            <button class="back_btn" type="button" onclick="location.href='${pageContext.request.contextPath}/admin1/faq/list'">취소</button>
...
<script>
  ...
  function check_faq(event) {
    ...
    if (frm.faq_title.value.trim() === "" || frm.faq_con.value.trim() === "") {
      ...
      frm.action = "${pageContext.request.contextPath}/admin1/faq/insert";
      frm.submit();
    }
  }
</script>
