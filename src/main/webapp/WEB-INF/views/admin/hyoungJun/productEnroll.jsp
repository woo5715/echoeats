...
<div id="layoutSidenav_content">
    ...
    <!-- contents-area -->
    <form action="/admin/hyoungJun/productEnroll" method="post" id="enrollForm">
                                        ...
                                        <div class="form-group">
                                            <div class="seller-calendar">
                                                <div class="form-inline">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input name="sel_str_date" autocomplete="off" readonly="readonly" class="form-control">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <input name="sel_end_date" autocomplete="off" readonly="readonly" class="form-control">
                                                            <span class="input-group-addon">
                                                            <a role="button" href></a>
                                                        </span>
                                                        </div>
                                            ...
                                            <div class="form-inline">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        btn-sm dropdown-toggle"
                                                                    data-toggle="dropdown" type="button"
                                                                    aria-expanded="false">Y <span class="caret"></span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <a role="button" href class="btn btn-default2 btn-sm">선택목록 일괄수정</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
